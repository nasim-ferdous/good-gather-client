    ...
    <div className="bg-emerald-100 dark:bg-zinc-800 py-10 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {features.map((feature) => (
          <div
            key={feature.id}
            className="p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-100 dark:hover:bg-emerald-200"
          >
